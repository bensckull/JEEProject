...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1698 COMMENT='Table definissant un projet du site.';


CREATE TABLE IF NOT EXISTS `participant` (
	`idParticipant` int(11) NOT NULL,
  	`idProjet` int(11) NOT NULL,
	`montantDonne` int(11) NOT NULL DEFAULT '10' COMMENT='Participation e 10 euro par defaut.',  
