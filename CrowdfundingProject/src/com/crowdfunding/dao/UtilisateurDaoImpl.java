...
public class UtilisateurDaoImpl implements UtilisateurDao {
    ...
    private static final String SQL_INSERT           = "INSERT INTO utilisateur (nom, prenom, pseudo, email, motdepasse, dateInscription) VALUES (?, ?, ?, ?, ?, NOW())";
...
//                utilisateur.setId( valeursAutoGenerees.getInt(10);	//notre id n'est pas auto généré
//            } else {
